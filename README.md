...
**Ziel:** Generiere folgenden Ausgabe mit nur so wenig Code wie möglich und höchstens einer `for schleife`.
## Aufgabe: Zahlen ausgeben
### Anforderungen:
1. Lies ein ganze Zahle (`int`) von der Konsole ein.
2. Nutze ein `for schleife`, um die Ausgabe in die Konsole auszugeben.
